...
class DDPM(pl.LightningModule):
    ...
    def q_sample(self, x_start, t, noise=None, style_latent=None):
        if style_latent is not None:
            init_rand = torch.rand_like(style_latent)
            std_diff = style_latent.std()/init_rand.std()
            sec_init_rand = (init_rand*std_diff)
            mean_diff = style_latent.mean()-sec_init_rand.mean()
            noise = sec_init_rand+mean_diff
        else:
